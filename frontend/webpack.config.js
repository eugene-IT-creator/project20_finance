    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                ...
                // { from: "./node_modules/admin-lte/plugins/moment/locale/ru.js", to: "js/moment-ru-locale.js" }, // for Russian
                ...
                // { from: "./node_modules/admin-lte/plugins/fullcalendar/locales/ru.js", to: "js/fullcalendar-locale-ru.js" }, // for Russian
            ],
        }),
    ],
};
